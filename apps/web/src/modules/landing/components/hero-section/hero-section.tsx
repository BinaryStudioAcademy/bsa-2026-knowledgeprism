...
const HERO_SECTION_CLASS = {
	...
	SECONDARY_LINK: `inline-flex items-center justify-center gap-2 rounded-md border border-border bg-surface px-5 py-2.5 text-[13px] font-medium leading-normal text-text no-underline transition-colors hover:bg-border-subtle hover:no-underline ${LANDING_FOCUS_RING}`,
} as const;
