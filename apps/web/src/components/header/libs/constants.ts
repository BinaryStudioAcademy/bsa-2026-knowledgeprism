...
const HeaderClass = {
	BAR: "flex min-h-[72px] flex-wrap items-center justify-between px-6 tablet-small:px-10",
	BRAND:
	...
	NAV: "basis-full flex-col gap-4 pb-5 tablet-small:flex tablet-small:basis-auto tablet-small:flex-row tablet-small:items-center tablet-small:gap-8 tablet-small:p-0",
	NAV_CLOSED: "hidden",
	NAV_OPEN: "flex",
	...
	TOGGLE:
		"cursor-pointer border-0 bg-transparent p-2 text-text tablet-small:hidden",
} as const;
